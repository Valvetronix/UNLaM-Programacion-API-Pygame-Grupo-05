...
def load_assets():
    ...
    global TOWER_IMAGE, BACKGROUND_IMAGE, MOUNTAINS_IMAGE, GRAVEYARD_IMAGE, WINDOW_ICON, GROUND_IMAGE, ANIM_HERO_JUMP, ANIM_HERO_FALL, ANIM_GHOST_FLY, CONTROLS_BACKGROUND

    # MENU
    CONTROLS_BACKGROUND = pygame.image.load(r"Assets\FondoControles.jpg")
